...
public:
	...
	DEFINE_MEMBER_FN(ctor, BSShaderTextureSet *, 0x012E0A80);
};
...
public:
	...
	DEFINE_MEMBER_FN(GetCostliestEffectItem, EffectItem *, 0x00101E40, int arg1, bool arg2);
	DEFINE_MEMBER_FN(GetEffectiveMagickaCost, float, 0x00101BB0, Character* caster);
};
...
public:
	...
	DEFINE_MEMBER_FN(GetSex, char, 0x00351500);
	DEFINE_MEMBER_FN(HasOverlays, bool, 0x00368C80);

	// Swaps a headPart of the same type as target with target
	DEFINE_MEMBER_FN(ChangeHeadPart, void, 0x00365E50, BGSHeadPart * target);
	...
	DEFINE_MEMBER_FN(UpdateNeck, void, 0x00360930, BSFaceGenNiNode * faceNode);

	// Computes RGB SkinTone from RGBA TintMask
	DEFINE_MEMBER_FN(SetSkinFromTint, void, 0x003606E0, NiColorA * result, TintMask * tintMask, UInt32 compute, UInt32 unk1);
