...
RelocAddr<uintptr_t> kHook_ContainerMode_Base(0x0085F570);
...
RelocAddr<uintptr_t> kHook_BGSKeyword_Base(0x00333D90);
uintptr_t kHook_BGSKeyword_Create_Return = kHook_BGSKeyword_Base + 6;

// 4C1457C3040DCD34A7E7B2326F1EA2023930C56B+71
RelocAddr <char *> g_gameVersion(0x0155EEF0);
RelocAddr <uintptr_t> kHook_ShowVersion_Offset(0x008EF2C0 + 0x78);
...
RelocAddr<uintptr_t> kHook_Crosshair_LookupREFRByHandle_Enter(0x006B0A20 + 0x90);
...
RelocAddr<uintptr_t> kHook_MapMenuMouseWheel_Enter(0x008DD350 + 0x18B);
